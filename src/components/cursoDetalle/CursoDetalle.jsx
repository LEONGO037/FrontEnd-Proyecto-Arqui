...
const VISUAL_MAP = {
  1: { icono: '💻', color: 'linear-gradient(135deg,#003366,#0055aa)', categoria: 'Tecnología', tags: ['Python', 'Java', 'UML'], docente: 'Lic. María Fernández' },
  2: { icono: '📐', color: 'linear-gradient(135deg,#1e3a5f,#2e6da4)', categoria: 'Ciencias', tags: ['Álgebra', 'Física', 'Ingeniería'], docente: 'Dr. Carlos Mendoza' },
  3: { icono: '📊', color: 'linear-gradient(135deg,#5a8a1a,#8cc63f)', categoria: 'Negocios', tags: ['Management', 'Liderazgo', 'Estrategia'], docente: 'Mg. Ana Quiroga' },
  4: { icono: '🌎', color: 'linear-gradient(135deg,#4338ca,#6366f1)', categoria: 'Idiomas', tags: ['B2-C1', 'Business', 'Speaking'], docente: 'Prof. David Smith' },
  5: { icono: '🎨', color: 'linear-gradient(135deg,#b45309,#f59e0b)', categoria: 'Diseño', tags: ['Figma', 'Prototipado', 'Usabilidad'], docente: 'Dis. Laura Quispe' },
  6: { icono: '📈', color: 'linear-gradient(135deg,#065f46,#10b981)', categoria: 'Datos', tags: ['Python', 'ML', 'Visualización'], docente: 'Ing. Roberto Flores' },
};
...
const CursoDetalle = ({ curso, inscrito, preinscrito, onClose, onInscribirse, onEliminarPreinscripcion }) => {
  const v = VISUAL_MAP[curso?.id] || { icono: '📚', color: '#003366', categoria: 'Curso', tags: [], docente: '-' };
